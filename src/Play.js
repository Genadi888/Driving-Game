...
class Play extends Phaser.Scene {
    ...
    create() {
        ...
        const tileset2 = map.addTilesetImage('objectspack_01', 'objects_key');
        const tileset4 = map.addTilesetImage('cars_tileset', 'cars_set_key');
        const layer1 = map.createLayer('Background', tileset4, 0, 0);
        const layer2 = map.createLayer('Layer 1', [tileset2, tileset4], 0, 0);
